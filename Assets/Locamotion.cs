...
public class Locamotion : NetworkBehaviour
{
    ...
    float RunSpeed = 4f;
    float LandSpeed = 4f;
    Transform ganyu = null;
    void Start()
    {
        cameratransform = Camera.main.transform;
        ganyu = transform.Find("ganyu");
        //锁定鼠标
        ...
        animator = ganyu.GetComponent<Animator>();
        playertransform = ganyu.GetComponent<Transform>();

        rigBuilder = ganyu.GetComponent<RigBuilder>();
